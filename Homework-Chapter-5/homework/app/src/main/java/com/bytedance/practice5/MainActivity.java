...
public class MainActivity extends AppCompatActivity {
    ...
    private void getData(String studentId){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d("run"," return list");
                if(message.feeds != null && !message.feeds.isEmpty()){
                    Log.d("Return List","has sonething in!");
    ...
    {
        String urlStr;
                if(studentID != null) urlStr = String.format(Constants.BASE_URL + "messages?student_id=%s",studentID);
                else urlStr = String.format(Constants.BASE_URL + "messages");
