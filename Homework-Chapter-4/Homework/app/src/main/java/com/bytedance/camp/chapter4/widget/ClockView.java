...
public class ClockView extends View {
    ...
    private void drawTimeNeedles(Canvas canvas) {
        ...
        canvas.drawLine(centerX, centerY,
                (float)(centerX + Math.cos(Math.toRadians(hourDegree)) * HOUR_NEEDLE_LENGTH_RATIO * radius), (float)(centerY + Math.sin(Math.toRadians(hourDegree)) * HOUR_NEEDLE_LENGTH_RATIO * radius),
                needlePaint);
        needlePaint.setStrokeWidth(MINUTE_NEEDLE_WIDTH);
        canvas.drawLine(centerX,centerY,
                (float)(centerX + Math.cos(Math.toRadians(minuteDegree)) * MINUTE_NEEDLE_LENGTH_RATIO * radius), (float)(centerY + Math.sin(Math.toRadians(minuteDegree)) * MINUTE_NEEDLE_LENGTH_RATIO * radius),
                needlePaint);
        needlePaint.setStrokeWidth(SECOND_NEEDLE_WIDTH);
        canvas.drawLine(centerX,centerY,
                (float)(centerX + Math.cos(Math.toRadians(secondDegree)) * SECOND_NEEDLE_LENGTH_RATIO * radius), (float)(centerY + Math.sin(Math.toRadians(secondDegree)) * SECOND_NEEDLE_LENGTH_RATIO * radius),
                needlePaint);
